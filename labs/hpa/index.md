...
In Amazon EKS, the Metrics Server is available as an addon. Let's verify its installation and proper functioning.
...
Note that EKS typically deploys two replicas of the metrics-server for high availability.
